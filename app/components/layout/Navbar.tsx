...
export default function Navbar() {
  return (
    <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-4 md:px-8 md:py-5 lg:px-7 lg:py-6">
      ...
      <div className="flex items-center bg-[#1a1a1a]/80 backdrop-blur-sm rounded-full border border-white/10 px-1 py-1">
        <Link
          href="#"
          className="px-4 py-2 md:px-5 md:py-2.5 text-white text-xs md:text-sm font-medium hover:bg-white/10 rounded-full transition-colors whitespace-nowrap"
        >
          Home
        </Link>
        <Link
      ...
      <Link
        href="#"
        className="flex items-center gap-2 bg-white rounded-full pl-4 pr-1.5 py-1.5 md:pl-5 md:pr-2 md:py-2 hover:bg-gray-100 transition-colors group"
      >
